...
(1, 'Belajar SQL', 'Pak Budi', 80000.00, 8),
(2, 'Pemrograman Web', 'Bu Sari', 120000.00, 5);
...
(1, 'Andi', 500000.00, 'REGULER'),
(2, 'Rina', 6000000.00, 'PLATINUM');

--
-- Triggers `pelanggan`
--
DELIMITER $$
CREATE TRIGGER `updatestatusmemberotomatis` BEFORE UPDATE ON `pelanggan` FOR EACH ROW IF NEW.total_belanja >= 5000000 THEN
